...
export default class SidebarRender extends PureComponent  {
  handleClick = (e) => {
    ...
    return (
      <div className="sidebar_container">
        <div className="sidebar_header_container">
          ...
          <p className="sidebar_under"> - Webdeveloper - </p>
        </div>
        ...
        <div>
          ...
          <button className="sidebar_button" onClick={this.handleClick} value="https://www.linkedin.com/in/rbhgn/"><Icon name="linkedin" color="#ffffff" width={48} height={48}  /></button>
        </div>
      </div>
    )
  }
